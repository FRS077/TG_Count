...
.button {
  ...
  margin: 4px 2px;
  border-radius: 8px;
  box-shadow: 2px 8px 10px #424242;
}
...
.node1 {
    ...
    text-align: center;
    font-weight:600;
    background: linear-gradient(to bottom, transparent 0%, #3d7df5 0%), linear-gradient(#F7f7f7, #EEE);
}
...
.node3 {
    ...
    text-align: center;
    font-weight:600;
    background: linear-gradient(to bottom, transparent 0%, #a37103 0%), linear-gradient(#F7f7f7, #EEE);
}
...
.node-talk1 {
    ...
    font-weight:600;
    // font-family: "Lucidia Console",Monaco,monospace;
    background: linear-gradient(to bottom, transparent 0%,  #C0C0C0 0%), linear-gradient(#F7f7f7, #EEE);
}
